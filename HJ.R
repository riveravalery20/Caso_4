...
JAPON_sep <- JAPON %>%
  separate(
    ...
    into = c("STRUCTURE","STRUCTURE_ID","STRUCTURE_NAME","ACTION","REF_AREA","VACIO1",
             "MEASURE","VACIO2","FREQ","VACIO3","TIME_PERIOD","VACIO4","OBS_VALUE","VACIO5",
             "OBS_STATUS","VACIO6","UNIT_MEASURE","VACIO7","UNIT_MULT","VACIO8","CURRENCY",
             "VACIO9","BASE_PER","VACIO10","METHODOLOGY","VACIO11","DECIMALS","VACIO12",
             "PRICE_BASE","VACIO13","ADJUSTMENT"),
    sep = ",", fill = "right"
  )
